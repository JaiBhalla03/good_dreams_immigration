    ...
    return (
        ...
        >
            <ul className={'bg-white border-l border-t border-r border-gray-500 flex flex-col'}>
                ...
                <Link className={'flex items-center justify-center p-4 text-xl border-b hover:bg-red-800 hover:text-white duration-300 transition-all border-gray-500 text-gray-500'} href={'temporary'}>Temporary Resident Visa(TRV)</Link>
