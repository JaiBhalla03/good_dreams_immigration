...
const Why = () => {
    ...
    return (
        <div ref={ref} className={'bg-gray-100 flex px-20 w-full gap-4 justify-between py-16'}>
            <div className={'pt-6 px-8 bg-white pb-8 flex gap-8'}>
                <motion.div
                    animate={controls}
                    initial={'hidden'}
                    variants={imageVariants}
                    className={'w-1/2 rounded-md flex items-center'}
                >
                    <Image src={whyHomeImage} alt={''} className={'rounded-md shadow shadow-md shadow-gray-500 w-full object-contain'}/>
                </motion.div>
                <div className={'w-1/2'}>
                    <motion.h1
                        animate={controls}
                        ...
                        className={'relative flex gap-2 justify-end text-4xl font-bold text-red-800'}
                    >
                        Why Choose Us <div className={'animate-bounce'}>?</div>
                        <span className={'absolute -bottom-2 end-0 w-1/3 bg-red-400 h-1 animate-pulse'}></span>
                    </motion.h1>
                    <div className={'flex w-full mt-10 flex-col gap-4 justify-between'}>
                        <div className={'flex w-full gap-4 items-center'}>
                            ...
                            <motion.div
                                ...
                                className={'flex flex-col pb-4 border-b border-gray-500'}>
                                <h1 className={'text-gray-900 font-bold text-2xl'}>Integrity</h1>
                        ...
                        <div className={'flex w-full gap-4 items-center'}>
                            ...
                            <motion.div
                                ...
                                className={'flex flex-col pb-4 border-b border-gray-500'}>
                                <h1 className={'text-gray-900 font-bold text-2xl'}>Customer Service</h1>
                                <p className={'text-gray-800 font-semibold text-xl'}>
                        ...
                        <div className={'flex w-full gap-4 items-center'}>
                            ...
                            <motion.div
                                ...
                                className={'flex flex-col pb-4 border-b border-gray-500'}>
                                <h1 className={'text-gray-900 font-bold text-2xl'}>Customized Options</h1>
                                <p className={'text-gray-800 font-semibold text-xl'}>
                        ...
                        <div className={'flex w-full gap-4 items-center'}>
                            ...
                            <motion.div
                                ...
                                className={'flex flex-col pb-4 border-b border-gray-500'}>
                                <h1 className={'text-gray-900 font-bold text-2xl'}>Professional Consultants</h1>
                                <p className={'text-gray-800 font-semibold text-xl'}>
