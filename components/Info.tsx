...
const Info = () => {
    return (
        <div className={'h-10 text-gray-800 bg-gray-200 flex justify-center items-center'}>
            <div className={'flex gap-8'}>
                ...
                <div className={'flex gap-2 items-center'}>
                    <IoLogoWhatsapp size={18} className={'hover:scale-105 duration-300 transition-all hover:text-gray-900 cursor-pointer'}/>
                    <AiFillFacebook size={18} className={'hover:scale-105 duration-300 transition-all hover:text-gray-900 cursor-pointer'}/>
                    <AiOutlineTwitter size={18} className={'hover:scale-105 duration-300 transition-all hover:text-gray-900 cursor-pointer'}/>
                    <AiFillInstagram size={18} className={'hover:scale-105 duration-300 transition-all hover:text-gray-900 cursor-pointer'}/>
                </div>
            </div>
        </div>
    );
